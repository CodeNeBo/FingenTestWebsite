...
function MyCarousel() {
  ...
  const sortedData = data.sort((a, b) => a.edgenumber - b.edgenumber);
  const top10Data = sortedData.slice(0, 10);

  return (
    <Carousel responsive={responsive} slidesToSlide={3} swipeable>
        ...
        return (
          ...
          >
            <div className="inline-flex gap-2 md:gap-3 items-center">
              ...
              <p
                className={`text-textcolor text-xs md:text-sm font-normal px-2 py-1 rounded-full border border-textcolor z-20 ${
                  percentage >= 0 }`}
              >
                {percentage}%
              </p>
