...
const Card = ({ title, currentNumber, lastMonthNumber, historyData }) => {
  ...
  return (
    <div className='p-px bg-gradient-to-br from-[#6A6A9B] to-[#100F1D] rounded-lg overflow-clip w-full -z-40 relative h-full'>
      <div className="bg-primary text-textcolor p-5 relative overflow-hidden inline-flex justify-between font-main w-full h-full rounded-[8px] md:rounded-[12px] lg:rounded-[9px]">
